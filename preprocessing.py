...
g = pickle.load(open('data/aida/test0_1_graph.pkl', 'rb'))
...
import pickle
pickle.dump(rel2ind, open('data/aida/rel2ind.pkl', 'wb'))
pickle.dump(ind2rel, open('data/aida/ind2rel.pkl', 'wb'))

# also for train, val, test
pickle.dump(rel_indices_train, open('data/aida/rel_indices_train.pkl', 'wb'))
pickle.dump(rel_indices_val, open('data/aida/rel_indices_val.pkl', 'wb'))
pickle.dump(rel_indices_test, open('data/aida/rel_indices_test.pkl', 'wb'))
...
pickle.dump(node2ind, open('data/aida/node2ind.pkl', 'wb'))
pickle.dump(ind2node, open('data/aida/ind2node.pkl', 'wb'))

# also for train, val, test
pickle.dump(node2ind_train, open('data/aida/node2ind_train.pkl', 'wb'))
pickle.dump(ind2node_train, open('data/aida/ind2node_train.pkl', 'wb'))
pickle.dump(node2ind_val, open('data/aida/node2ind_val.pkl', 'wb'))
pickle.dump(ind2node_val, open('data/aida/ind2node_val.pkl', 'wb'))
pickle.dump(node2ind_test, open('data/aida/node2ind_test.pkl', 'wb'))
pickle.dump(ind2node_test, open('data/aida/ind2node_test.pkl', 'wb'))
...
pickle.dump(train_graph, open('data/aida/test0_1_train_graph.pkl', 'wb'))
pickle.dump(val_graph, open('data/aida/test0_1_val_graph.pkl', 'wb'))
pickle.dump(test_graph, open('data/aida/test0_1_test_graph.pkl', 'wb'))

# dump final graph to pickle
pickle.dump(g, open('data/aida/test0_1_graph.pkl', 'wb'))